...
| ADR | Decision | Status |
|---|---|---|
| [0001](0001-deterministic-scheduler-inference-boundary.md) | Deterministic scheduler; bounded inference proposals | Accepted |
| [0002](0002-local-first-storage.md) | Local-first storage | Accepted |
| [0003](0003-modular-monolith.md) | Modular monolith | Accepted |
| [0004](0004-capability-selected-inference.md) | Capability-selected inference | Accepted |
