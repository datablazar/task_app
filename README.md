...
A local-first task and calendar application that automatically builds and repairs a realistic schedule. Deterministic rules enforce constraints; optional LLM assistance handles bounded ambiguity.
...
- Agent entry points: [Codex](AGENTS.md), [Claude Code](CLAUDE.md), [Gemini/Antigravity](GEMINI.md).
